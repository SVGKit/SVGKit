...
//    CGPoint startPos = CGPointMake([attributes objectFor, <#CGFloat y#>)
    ...
    {
        returnObject = currentElement = [[SVGGradientElement alloc] initWithDocument:document name:name];    
        [currentElement parseAttributes:attributes];
        
        [document setFill:currentElement forId:currentElement.identifier];
    }
