...
+(void) configureCALayer:(CALayer*) layer usingElement:(SVGElement*) nonStylableElement
{
    ...
    if( [nonStylableElement conformsToProtocol:@protocol(SVGStylable)])
    {
        ...
        [layer setValue:[stylableElement cascadedValueForStylableProperty:@"customRotate"] forKey:@"customRotate"];
        [layer setValue:[stylableElement cascadedValueForStylableProperty:@"isLocked"] forKey:@"isLocked"];
