...
+(float) pixelsPerInchForCurrentDevice
{
    ...
    if( [platform hasPrefix:@"iPad5,1"]
       ...
       || [platform hasPrefix:@"iPad2,5"]
       || [platform hasPrefix:@"iPad2,6"]
       || [platform hasPrefix:@"iPad2,7"]
       || [platform hasPrefix:@"iPad4,4"]
       || [platform hasPrefix:@"iPad4,5"]
       || [platform hasPrefix:@"iPad4,6"]
       || [platform hasPrefix:@"iPad4,7"]
       || [platform hasPrefix:@"iPad4,8"]
       || [platform hasPrefix:@"iPad4,9"]
       || [platform hasPrefix:@"iPad11,1"]
       || [platform hasPrefix:@"iPad11,2"]
       || [platform hasPrefix:@"iPad14,1"]
       || [platform hasPrefix:@"iPad14,2"])
        return 326.0f;
    ...
    if( [platform hasPrefix:@"iPad3"]
       ...
       || [platform hasPrefix:@"iPad11,1"]
       || [platform hasPrefix:@"iPad11,2"]
       || [platform hasPrefix:@"iPad11,3"]
       || [platform hasPrefix:@"iPad11,4"]
       || [platform hasPrefix:@"iPad11,6"]
       || [platform hasPrefix:@"iPad11,7"]
       || [platform hasPrefix:@"iPad12,1"]
       || [platform hasPrefix:@"iPad12,2"]
       || [platform hasPrefix:@"iPad13,1"]
       || [platform hasPrefix:@"iPad13,2"]
       || [platform hasPrefix:@"iPad13,4"]
       || [platform hasPrefix:@"iPad13,5"]
       || [platform hasPrefix:@"iPad13,6"]
       || [platform hasPrefix:@"iPad13,7"]
       || [platform hasPrefix:@"iPad13,8"]
       || [platform hasPrefix:@"iPad13,9"]
       || [platform hasPrefix:@"iPad13,10"]
       || [platform hasPrefix:@"iPad13,11"]
       || [platform hasPrefix:@"iPad13,16"]
       || [platform hasPrefix:@"iPad13,17"]
       || [platform hasPrefix:@"iPad13,18"]
       || [platform hasPrefix:@"iPad13,19"])
        return 264.0f;

    if( [platform hasPrefix:@"iPad1,1"]
       || [platform hasPrefix:@"iPad2,1"]
    ...
    if( [platform hasPrefix:@"iWatch6,18"])
        return 338.0f;

    if( [platform hasPrefix:@"iWatch1"]
       || [platform hasPrefix:@"iWatch2"]
       || [platform hasPrefix:@"iWatch3"]
       || [platform hasPrefix:@"iWatch4"]
       || [platform hasPrefix:@"iWatch5"]
       || [platform hasPrefix:@"iWatch6"])
        return 326.0f;
