...
@interface SVGKAppleSucksDOMImplementation : NSObject

-(BOOL) hasFeature:(NSString*) feature version:(NSString*) version;

// Introduced in DOM Level 2:
-(SVGKDocumentType*) createDocumentType:(NSString*) qualifiedName publicId:(NSString*) publicId systemId:(NSString*) systemId;

// Introduced in DOM Level 2:
-(SVGKDocument*) createDocument:(NSString*) namespaceURI qualifiedName:(NSString*) qualifiedName doctype:(SVGKDocumentType*) doctype;
