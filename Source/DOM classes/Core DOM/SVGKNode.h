...
@property(nonatomic,assign,readonly) SVGKNode* parentNode;
@property(nonatomic,retain,readonly) SVGKNodeList* childNodes;
@property(nonatomic,assign,readonly) SVGKNode* firstChild;
@property(nonatomic,assign,readonly) SVGKNode* lastChild;
@property(nonatomic,assign,readonly) SVGKNode* previousSibling;
@property(nonatomic,assign,readonly) SVGKNode* nextSibling;
@property(nonatomic,retain,readonly) SVGKNamedNodeMap* attributes; /*< NB: according to DOM Spec, this is null if the Node is NOT subclassed as an Element */

// Modified in DOM Level 2:
@property(nonatomic,assign,readonly) SVGKDocument* ownerDocument;
